...
package com.github.deckyfx.listviewwithloadingindicator;
...
public class ListViewWithLoadingIndicator extends ListView implements ListViewWithLoadingIndicatorListener {

    private ListViewWithLoadingIndicatorHelper listViewWithLoadingIndicatorHelper;

    public ListViewWithLoadingIndicator(Context context) {
        this(context, null, 0);
    }

    public ListViewWithLoadingIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public ListViewWithLoadingIndicator(Context context, AttributeSet attrs, int defStyle) {
